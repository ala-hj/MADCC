...
import UIKit
public
class TableViewST: UITableViewController {
    ...
    override public func viewDidLoad() {
        super.viewDidLoad()
        objectsArray = [Objects(sectionName: "Safety Technology", sectionObjects: ["Program Mission","Program Objectives","Professional Occupations","Program Faculty","Curriculum Overview"])]
        // _________________________________________________
        identifies = ["ProgramMissionST","ProgramObjectivesST","ProfessionalOccupationsST","ProgramFacultyST","CurriculumOverviewST"]
    }
    ...
    override public func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cellST = tableView.dequeueReusableCellWithIdentifier("cellST") as UITableViewCell!
        
        cellST.textLabel?.text = objectsArray[indexPath.section].sectionObjects[indexPath.row ]
