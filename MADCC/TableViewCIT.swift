...
import UIKit
public
class TableViewCIT: UITableViewController {
    ...
    override public func viewDidLoad() {
        ...
        objectsArray = [Objects(sectionName: "Computer & Informaition Technology", sectionObjects: ["Program Mission","Program Objectives","Learning Outcomes","Professional Occupations","Program Faculty","Curriculum Overview"])]
        // _______________________________________________________________
        // HERE, we move to the other views by these big-boys.
        
        identifies = ["ProgramMissionCIT","ProgramObjectivesCIT","LearningOutcomesCIT","ProfessionalOccupationsCIT","ProgramFacultyCIT","CurriculumOverviewCIT"]
    ...
    override public func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cellCIT = tableView.dequeueReusableCellWithIdentifier("cellCIT") as UITableViewCell!
        
        cellCIT.textLabel?.text = objectsArray[indexPath.section].sectionObjects[indexPath.row ]
