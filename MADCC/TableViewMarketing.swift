...
import UIKit
public
class TableViewMarketing: UITableViewController {
    ...
    override public func viewDidLoad() {
        super.viewDidLoad()
        objectsArray = [Objects(sectionName: "Marketing", sectionObjects: ["Program Mission","Program Objectives","Learning Outcomes","Professional Occupations","Program Faculty","Curriculum Overview"])]
        // _________________________________________________
        identifies = ["ProgramMissionMR","ProgramObjectivesMR","LearningOutcomesMR","ProfessionalOccupationsMR","ProgramFacultyMR","CurriculumOverviewMR"]
    }
    ...
    override public func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cellMR = tableView.dequeueReusableCellWithIdentifier("cellMR") as UITableViewCell!
        
        cellMR.textLabel?.text = objectsArray[indexPath.section].sectionObjects[indexPath.row ]
